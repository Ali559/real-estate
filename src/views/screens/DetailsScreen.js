            ...
            <View style={style.backgroundImageContainer}>
                <ImageBackground style={style.backgroundImage} source={house.image} >
                    <View style={style.header}>
                        <View style={{
                            backgroundColor: COLORS.white, borderRadius: 5, height: 50,
                            width: 50, justifyContent: 'center', alignItems: 'center'
                        }}>
                            <Icon onPress={navigation.goBack} name="arrow-back-ios" style={{ padding: 10 }} size={20} color={COLORS.dark} />
                        </View>
                        <View style={{
                            backgroundColor: COLORS.white, borderRadius: 5, height: 50,
                            width: 50, justifyContent: 'center', alignItems: 'center'
                        }}>
                            <Icon onPress={() => (heartColor == COLORS.red) ? setHeartColor(COLORS.grey) : setHeartColor(COLORS.red)}
                                name="favorite" size={20} color={heartColor} style={{ padding: 10 }} />
                        </View>
                    </View>

                </ImageBackground>
                <View style={{
                    width: 120, height: 40, backgroundColor: COLORS.dark,
            ...
            <View style={style.detailsContainer}>
                ...
                <View style={{ marginTop: 10, flexDirection: 'row' }}>
                    ...
                    <View style={{
                        ...
                        <Text style={{ marginLeft: 5, color: COLORS.grey }}>{house.area} area</Text>
                    </View>
                </View>
                ...
                <View style={{
                    ...
                    <View>
                        <Text style={{ color: COLORS.blue, fontWeight: 'bold', fontSize: 18 }}>${house.price}</Text>
                ...
                <Pressable onPress={() => navigation.navigate('InteriorScreen', house)}>
                    <View style={[ house.bedrooms ? style.InteriorImagesPage : { display: 'none' } ]}>
                        <Text style={{ color: COLORS.light, fontSize: 18, }}>View House</Text>
                    </View>
                </Pressable>
            </View>
        </ScrollView>
