    ...
    >
      <View style={style.categoryCard}>
        ...
        >
          ...
          >
            {house.price.includes("$") ? house.price : `$${house.price}`}
          </Text>
        </View>
        <Text style={{ marginTop: 5, color: COLORS.grey, fontSize: 14 }}>
          {house.location}
        </Text>
        <View style={{ marginTop: 10, flexDirection: "row" }}>
          ...
          >
            <Icon
              onPress={() => {
                Alert.alert("دڵنیا کردنەوە", "دڵنیای لە سڕینەوەی ئەم موڵکە؟", [
                  {
                    text: "نەخێر",
                    onPress: () => {
                      return;
